...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_folder', default='neonate_results_txt/', type=str, help='Dir to save txt results')
    parser.add_argument('--dataset_folder', default='data/neonate/test/images/', type=str, help='dataset path')
    parser.add_argument('--folder_pict', default='data/neonate/test/label.txt', type=str, help='folder_pict')
